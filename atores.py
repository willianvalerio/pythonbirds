...
class Passaro(Ator):
    ...
    def _calcular_posicao_vertical(self, delta_t):
        ...
        angula_radianos = self._angulo_de_lancamento
        y_atual += self.velocidade_escalar * delta_t * math.sin(angula_radianos)
    ...
    def _calcular_posicao_horizontal(self, delta_t):
        ...
        angula_radianos = self._angulo_de_lancamento
        x_atual += self.velocidade_escalar * delta_t * math.cos(angula_radianos)
        self.x = x_atual
